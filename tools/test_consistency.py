"""Test shared design contracts, search parity and real routes.
Optional: --screenshots output/directory
...
preview=(ROOT.parent/'rebuub-clean-preview.html').read_text()
results=[]
